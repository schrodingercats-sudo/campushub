    ...
    <footer className="bg-pinnacle-green text-pinnacle-dark pt-24 pb-4 overflow-hidden relative">
      <div className="container mx-auto px-8">
        ...
        <div className="relative">
          <h1 className="font-display font-black text-[18vw] leading-[0.75] text-center tracking-tighter mb-0 pointer-events-none select-none">
      ...
      <div className="w-full flex justify-between items-center px-4 py-2 text-[10px] font-bold tracking-widest uppercase border-t border-black/10 mt-8 relative z-50 bg-pinnacle-green">
