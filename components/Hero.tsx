      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          ...
          <div className="mt-8 flex justify-center">
            <Link
              to="/login"
              className="group relative inline-flex items-center gap-3 px-8 py-4 bg-black text-white rounded-full font-bold uppercase tracking-widest overflow-hidden hover:bg-pinnacle-green hover:text-black transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
            >
